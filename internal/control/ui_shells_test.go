...
func TestConsoleShells_Static(t *testing.T) {
	...
	cases := []struct {
		...
		{"/supervisor/", http.StatusOK, "Light summary"},
		{"/supervisor/supervisor.js", http.StatusOK, "analyticsSummary"},
		{"/chat/", http.StatusOK, "edge_taken"},
		{"/chat/chat.js", http.StatusOK, "edge_taken"},
		{"/shared/api.js", http.StatusOK, "analyticsSummary"},
